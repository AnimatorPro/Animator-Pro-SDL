...
static PocoStatus compile_fixture(const PocoVmOptions* options, PocoProgram** out_program,
								  PocoVm** out_vm)
{
...
int main(void)
{
	...
	ok &=
		check(status != POCO_STATUS_OK, "generic VM rejects the legacy native-POE ABI by default");
