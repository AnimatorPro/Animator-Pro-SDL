...
static UBYTE xhair_pixels[] = {
	...
	_, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _,
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
	_, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _,
	_, _, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, M,
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, B, B, B, B, B, M, _, _, _, _, _, M, B, B,
	B, B, B, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, M, _, _, _, _, _, _, _, _, _, _,
	_, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _, _,
	_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
	_, _, _, B, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _,
	_, _, _, _, _, _, _, _, _, _, B, _, _, _, _, _, _, _, _, _,
};
...
static void show_default_cursor(Cursorhdr* ch)
{
	...
	procblit(&_default_cursor, 0, 0, screen, cx, cy, DFLT_CURS_HT, DFLT_CURS_WID, tbli_xlatline,
			 get_cursor_xlat());
}
...
Rastcursor* get_default_cursor(void)
{
	static Rastcursor dcurs = {
		{show_default_cursor, hide_default_cursor, NULL}, &_default_cursor, NULL};
	...
	pj_build_bytemap((Rasthdr*)&_default_cursor, (Raster*)&_default_cursor, xhair_pixels);
