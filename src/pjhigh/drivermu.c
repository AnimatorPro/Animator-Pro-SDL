...
/*** Button Data ***/
static Button drv_pick_sel =
	MB_INIT1(NONEXT,                                             /* next */
			 NOCHILD,                                            /* children */
			 294, 11, 21, 67,                                    /* w,h,x,y */
			 NODATA,                                             /* datme */
			 see_pick_entry, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button drv_ok_sel =
	MB_INIT1(&drv_pick_sel,                                               /* next */
			 NOCHILD,                                                     /* children */
			 77, 11, 21, 81,                                              /* w,h,x,y */
			 NODATA,                                                      /* "Ok", */
			 dcorner_text, verify_pick_close, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button drv_cancel_sel =
	MB_INIT1(&drv_ok_sel,                                                /* next */
			 NOCHILD,                                                    /* children */
			 77, 11, 223, 81,                                            /* w,h,x,y */
			 NODATA,                                                     /* "Cancel", */
			 dcorner_text, mb_gclose_cancel, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button drv_info_sel =
	MB_INIT1(&drv_cancel_sel,                                              /* next */
			 NOCHILD,                                                      /* children */
			 77, 11, 121, 81,                                              /* w,h,x,y */
			 NODATA,                                                       /* "Info", */
			 see_info_button, show_entry_info, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button drv_swin_sel = MB_INIT1(&drv_info_sel,   /* next */
									  NOCHILD,         /* children */
									  294, 52, 21, 12, /* w,h,x,y */
									  &sscroller, see_scroll_names, feel_scroll_cels, NOOPT,
									  &sscroller, 0, NOKEY, 0 /* flags */
);
static Button drv_incdn_sel =
	MB_INIT1(&drv_swin_sel,                                                 /* next */
			 NOCHILD,                                                       /* children */
			 14, 10, 5, 54,                                                 /* w,h,x,y */
			 &ctridown,                                                     /* datme */
			 ccorner_image, scroll_incdown, NOOPT, &sscroller, 0, DARROW, 0 /* flags */
	);
static Button drv_sbar_sel = MB_INIT1(&drv_incdn_sel, /* next */
									  NOCHILD,        /* children */
									  14, 30, 5, 23,  /* w,h,x,y */
									  &sscroller, see_scrollbar, rt_feel_scrollbar, NOOPT,
									  &sscroller, 0, NOKEY, 0 /* flags */
);
static Button drv_incup_sel =
	MB_INIT1(&drv_sbar_sel,                                               /* next */
			 NOCHILD,                                                     /* children */
			 14, 10, 5, 12,                                               /* w,h,x,y */
			 &ctriup,                                                     /* datme */
			 ccorner_image, scroll_incup, NOOPT, &sscroller, 0, UARROW, 0 /* flags */
	);
static Button drv_title_sel = MB_INIT1(&drv_incup_sel, /* next */
									   NOCHILD,        /* children */
									   320, 9, 0, 0,   /* w,h,x,y */
									   NULL, see_titlebar, feel_titlebar, mb_menu_to_bottom,
									   &tbg_moveclose, 0, NOKEY, 0 /* flags */
);
...
static void feel_1_scroll(Button* list_sel, Raster* rast, int x, int y, Names* entry, int why)
{
	(void)rast;
	(void)x;
	(void)y;
...
Errcode go_driver_scroller(char* title, Names* list, Names* initial_entry,
 ...
 */
{
	...
	if ((err = soft_buttons("driver_panel", drv_smblist, Array_els(drv_smblist), &ss)) < Success) {
		goto error;
	}
