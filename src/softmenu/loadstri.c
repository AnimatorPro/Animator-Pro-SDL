...
static Errcode smu_get_ss(struct softmenu* sm, char* symname, Smu_strings* s, unsigned class)
...
Errcode smu_load_text(struct softmenu* sm, char* symname, char** ptext)
