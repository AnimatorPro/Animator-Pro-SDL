...
static void _grc_get_hseg(Raster* v, Pixel* pixbuf, Coor x, Coor y, Ucoor width)
...
static void _grc_get_rectpix(Raster* v, Pixel* pixbuf, Coor x, Coor y, Ucoor width, Ucoor height)
