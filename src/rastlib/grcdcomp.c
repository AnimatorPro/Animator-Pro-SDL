...
static void grc_put_rectpix(Raster* v, Pixel* pixbuf, Coor x, Coor y, Ucoor width, Ucoor height)
...
static void _grc_set_hline(Raster* v, Pixel color, Coor x, Coor y, Ucoor width)
...
static void _grc_set_rect(Raster* v, Pixel color, Coor x, Coor y, Ucoor width, Ucoor height)
...
/* (Unclipped.) */
static void grc_unbrun_rect(Raster* v, void* ucbuf, LONG pixsize, Coor xorg, Coor yorg, Ucoor width,
							Ucoor height)
{
	Coor x, y;
	BYTE psize;
...
static void grc_unlccomp_rect(Raster* v, void* ucbuf, LONG pixsize, Coor xorg, Coor yorg,
...
static Errcode grc_unss2_rect(Raster* v, void* ucbuf, LONG pixsize, Coor xorg, Coor yorg,
							  Ucoor width, Ucoor height)
/* Uncompress data into a rectangular area inside raster using
