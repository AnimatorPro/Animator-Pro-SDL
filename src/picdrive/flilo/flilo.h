...
extern void* flow_brun_rect(struct raster* r, void* cbuf, SHORT x, SHORT y, USHORT width,
							USHORT height);

extern LONG flow_comp_cel(void* comp_buf, struct rcel* last_screen, struct rcel* this_screen,
						  SHORT type);
