 ...
 */
static Errcode alloc_and_open(Targa_file** ptf, char* path, enum XReadWriteMode mode)
{
	Errcode err;
	Targa_file* tf;
...
static Errcode save_frames(Image_file* ifile, Rcel* screen, ULONG num_frames,
...
Local_pdr targa_local_pdr = {NULL, targa_pdr_name, &targa_pdr_header};
