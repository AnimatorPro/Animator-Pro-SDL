...
static void draw_line(Rcel* screen, short x1, short y1, short x2, short y2, short color)
/* Draw a line. */
{
...
static void paint_line(Rcel* screen, short x1, short y1, short x2, short y2, short yend,
					   short color)
...
static Errcode paint_slide(Rcel* screen, Ifile* gf)
{
	...
	for (;;) {
		...
		if (tk.word >= 0) /* usual case, a line follows */
		{
			...
			paint_line(screen, lastx = tk.word, lasty = abuf[0], abuf[1], abuf[2], yend, color);
		} else {
			switch (tk.byte.hi) {
				case 0xfb: /* Offset vector */
				{
					...
					newy = bbuf[0] + lasty;
					paint_line(screen, newx, newy, lastx + bbuf[1], lasty + bbuf[2], yend, color);
					lastx = newx;
					lasty = newy;
				} break;
				...
				case 0xfd: /* Solid fill */
				{
									  ...
									  * toggle fill state */
					{
						...
						{
							if ((err = paint_poly(screen, polyx, polyy, poly_ix, color)) <
								Success) {
								return (err);
							}
						}
...
UBYTE auto_cmap[256 * 3] = {
	0,   0,   0,   252, 0,   0,   252, 252, 0,   0,   252, 0,   0,   252, 252, 0,   0,   252, 252,
	0,   252, 252, 252, 252, 252, 252, 252, 252, 252, 252, 252, 0,   0,   252, 124, 124, 160, 0,
	0,   160, 80,  80,  124, 0,   0,   124, 60,  60,  72,  0,   0,   72,  36,  36,  36,  0,   0,
	36,  16,  16,  252, 60,  0,   252, 156, 124, 160, 40,  0,   160, 100, 80,  124, 28,  0,   124,
	76,  60,  72,  16,  0,   72,  44,  36,  36,  8,   0,   36,  20,  16,  252, 124, 0,   252, 188,
	124, 160, 80,  0,   160, 120, 80,  124, 60,  0,   124, 92,  60,  72,  36,  0,   72,  56,  36,
	36,  16,  0,   36,  28,  16,  252, 188, 0,   252, 220, 124, 160, 120, 0,   160, 140, 80,  124,
	92,  0,   124, 108, 60,  72,  56,  0,   72,  64,  36,  36,  28,  0,   36,  32,  16,  252, 252,
	0,   252, 252, 124, 160, 160, 0,   160, 160, 80,  124, 124, 0,   124, 124, 60,  72,  72,  0,
	72,  72,  36,  36,  36,  0,   36,  36,  16,  188, 252, 0,   220, 252, 124, 120, 160, 0,   140,
	160, 80,  92,  124, 0,   108, 124, 60,  56,  72,  0,   64,  72,  36,  28,  36,  0,   32,  36,
	16,  124, 252, 0,   188, 252, 124, 80,  160, 0,   120, 160, 80,  60,  124, 0,   92,  124, 60,
	36,  72,  0,   56,  72,  36,  16,  36,  0,   28,  36,  16,  60,  252, 0,   156, 252, 124, 40,
	160, 0,   100, 160, 80,  28,  124, 0,   76,  124, 60,  16,  72,  0,   44,  72,  36,  8,   36,
	0,   20,  36,  16,  0,   252, 0,   124, 252, 124, 0,   160, 0,   80,  160, 80,  0,   124, 0,
	60,  124, 60,  0,   72,  0,   36,  72,  36,  0,   36,  0,   16,  36,  16,  0,   252, 60,  124,
