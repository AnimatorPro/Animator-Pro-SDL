...
extern Errcode conv_bitmaps(UBYTE* planes[], int pcount, int bpr, int width, int height,
							struct rcel* screen);

extern UBYTE* decode_vplane(UBYTE* comp, UBYTE* plane, int BytesPerRow);

extern UBYTE* decode_vkplane(UBYTE* comp, UBYTE* plane, int BytesPerRow, int* ytable);
