...
char* work_temp_files[] = /* files that are not needed for state saving */
	{ram_tflx_name, disk_tflx_name, flxolayname, NULL};

char* state_temp_files[] = /* files that are needed to save state */
	{
		tflxname,   tsettings_name,   alt_name,      screen_name, bscreen_name,
		cel_name,   cel_fli_name,     text_name,     cclip_name,  mask_name,
		poly_name,  ppoly_name,       another_name,  optics_name, rbf_name,
		tween_name, poco_source_name, poco_err_name, macro_name,  NULL,
};
