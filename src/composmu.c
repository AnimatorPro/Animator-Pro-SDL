...
static Button seg_rarr_sel =
	MB_INIT1(NONEXT,                                                     /* next */
			 NOCHILD,                                                    /* children */
			 12, 20, 305, 15,                                            /* w,h,x,y */
			 &cright,                                                    /* datme */
			 wbg_ncorner_image, inc_overlap, NOOPT, NOGROUP, 1, NOKEY, 0 /* flags */
	);
static Button seg_abslid_sel =
	MB_INIT1(&seg_rarr_sel,                                               /* next */
			 NOCHILD,                                                     /* children */
			 190, 20, 116, 15,                                            /* w,h,x,y */
			 NODATA,                                                      /* datme */
			 see_abslid_sel, feel_abslid_sel, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button seg_larr_sel =
	MB_INIT1(&seg_abslid_sel,                                             /* next */
			 NOCHILD,                                                     /* children */
...
static Button seg_w14_sel = MB_INIT1(&seg_larr_sel,   /* next */
									 NOCHILD,         /* children */
									 24, 15, 293, 80, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_DIAMOND, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w13_sel = MB_INIT1(&seg_w14_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 268, 80, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_DIAGBOT, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w12_sel = MB_INIT1(&seg_w13_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 243, 80, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_DIAGTOP, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w11_sel = MB_INIT1(&seg_w12_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 218, 80, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, set_blindmask_mode, opt_blindmask_size,
									 &vs.co_type, COMP_LOUVER, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w10_sel = MB_INIT1(&seg_w11_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 193, 80, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, set_blindmask_mode, opt_blindmask_size,
									 &vs.co_type, COMP_VENETIAN, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w09_sel = MB_INIT1(&seg_w10_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 293, 64, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_BOXLBOT, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w08_sel = MB_INIT1(&seg_w09_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 268, 64, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_BOXRBOT, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w07_sel = MB_INIT1(&seg_w08_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 243, 64, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_HORIZW, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w06_sel = MB_INIT1(&seg_w07_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 218, 64, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_VWEDGE, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w05_sel = MB_INIT1(&seg_w06_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 193, 64, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_BOX, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w04_sel = MB_INIT1(&seg_w05_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 293, 48, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_BOXRTOP, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w03_sel = MB_INIT1(&seg_w04_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 268, 48, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_BOXLTOP, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w02_sel = MB_INIT1(&seg_w03_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 243, 48, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_VERTW, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w01_sel = MB_INIT1(&seg_w02_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 218, 48, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_HWEDGE, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_w00_sel = MB_INIT1(&seg_w01_sel,    /* next */
									 NOCHILD,         /* children */
									 24, 15, 193, 48, /* w,h,x,y */
									 NULL,            /* datme */
									 see_trans_icon, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_CIRCLE, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_boxil_sel = MB_INIT1(&seg_w00_sel,   /* next */
									   NOCHILD,        /* children */
									   59, 9, 131, 82, /* w,h,x,y */
									   NODATA,         /* "Boxilate", */
									   wbg_ncorner_text, setup_nonmask_mode, set_boxil_size,
									   &vs.co_type, COMP_BOXIL, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_disol_sel = MB_INIT1(&seg_boxil_sel, /* next */
									   NOCHILD,        /* children */
									   59, 9, 131, 72, /* w,h,x,y */
									   NODATA,         /* "Dissolve", */
									   wbg_ncorner_text, setup_nonmask_mode, NOOPT, &vs.co_type,
									   COMP_DISSOLVE, NOKEY, MB_B_GHILITE /* flags */
);

static Button seg_mask_sel = MB_INIT1(&seg_disol_sel, /* next */
									  NOCHILD,        /* children */
									  59, 9, 131, 62, /* w,h,x,y */
									  NODATA,         /* "Custom", */
									  wbg_ncorner_text, setup_mask_mode, optload_mask_cel,
									  &vs.co_type, COMP_MASK, NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_cut_sel = MB_INIT1(&seg_mask_sel,  /* next */
									 NOCHILD,        /* children */
									 59, 9, 131, 52, /* w,h,x,y */
									 NODATA,         /* "Cut", */
									 wbg_ncorner_text, setup_nonmask_mode, NOOPT, &vs.co_type,
									 COMP_CUT, NOKEY, MB_B_GHILITE /* flags */
);
...
static Button seg_clabel_sel =
	MB_INIT1(NONEXT, NOCHILD,                                     /* children */
			 37, 9, 80, 50,                                       /* w,h,x,y */
			 NODATA,                                              /* "Colors", */
			 see_color_label, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button seg_colab_sel = MB_INIT1(&seg_clabel_sel, /* next */
									   NOCHILD,         /* children */
									   36, 11, 80, 80,  /* w,h,x,y */
									   NODATA,          /* "Blend", */
									   see_color_mode, change_mode, NOOPT, &vs.co_cfit, FIT_BLEND,
									   NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_colb_sel = MB_INIT1(&seg_colab_sel, /* next */
									  NOCHILD,        /* children */
									  36, 11, 80, 70, /* w,h,x,y */
									  NODATA,         /* "2:", */
									  see_color_mode, change_mode, NOOPT, &vs.co_cfit, FIT_TOB,
									  NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_cola_sel = MB_INIT1(&seg_cut_sel,   /* next */
									  &seg_colb_sel,  /* children */
									  36, 11, 80, 60, /* w,h,x,y */
									  NODATA,         /* "1:", */
									  see_color_mode, change_mode, NOOPT, &vs.co_cfit, FIT_TOA,
									  NOKEY, MB_B_GHILITE /* flags */
);

static Button seg_rev_sel =
	MB_INIT1(&seg_cola_sel, /* next */
			 NOCHILD,       /* children */
			 70, 9, 5, 82,  /* w,h,x,y */
			 NODATA,        /* "Reverse", */
			 ccorner_text, toggle_bgroup, NOOPT, &vs.co_reverse, 1, NOKEY, MB_B_GHILITE /* flags */
	);
static Button seg_size_sel = MB_INIT1(&seg_rev_sel, /* next */
									  NOCHILD,      /* children */
									  70, 9, 5, 72, /* w,h,x,y */
									  NODATA,       /* "Match Size", */
									  ccorner_text, toggle_bgroup, NOOPT, &vs.co_matchsize, 1,
									  NOKEY, MB_B_GHILITE /* flags */
);
static Button seg_swap_sel =
	MB_INIT1(&seg_size_sel,                                               /* next */
			 NOCHILD,                                                     /* children */
			 70, 9, 5, 62,                                                /* w,h,x,y */
			 NODATA,                                                      /* "Swap Ends", */
			 ccorner_text, tog_ends, NOOPT, NOGROUP, 0, NOKEY, MB_HIONSEL /* flags */
	);
static Button seg_still_sel =
	MB_INIT1(&seg_swap_sel, /* next */
			 NOCHILD,       /* children */
			 70, 9, 5, 52,  /* w,h,x,y */
			 NODATA,        /* "Still", */
			 ccorner_text, tog_redraw_group, NOOPT, &vs.co_still, 1, NOKEY, MB_B_GHILITE /* flags */
	);
static Button seg_modeinfo_sel =
	MB_INIT1(&seg_still_sel, /* next */
			 NOCHILD,        /* children */
			 320, 11, 2, 35, /* w,h,x,y */
			 NULL,           /* "Custom: ![1]  ![2] Frames, (![3] X ![4])", */
			 see_mode_info, NOFEEL, qload_mask_cel, NOGROUP, 0, NOKEY, MB_DISABOPT /* flags */
	);
static Button seg_nameb_sel =
	MB_INIT1(&seg_modeinfo_sel,                                       /* next */
			 NOCHILD,                                                 /* children */
			 99, 11, 2, 25,                                           /* w,h,x,y */
			 NODATA,                                                  /* "2: ![1]", */
			 see_fli_bname, NOFEEL, qload_fli_b, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button seg_namea_sel =
	MB_INIT1(&seg_nameb_sel,                                    /* next */
			 NOCHILD,                                           /* children */
			 99, 11, 2, 15,                                     /* w,h,x,y */
			 NODATA,                                            /* "1: ![1]", */
			 see_fli_aname, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
...
static Button seg_frames_sel =
	MB_INIT1(&seg_namea_sel,                                                          /* next */
			 NOCHILD,                                                                 /* children */
			 35, 11, 282, 2,                                                          /* w,h,x,y */
			 &frames_numq,                                                            /* datme */
			 see_olap_frames, feel_olap_frames, opt_olap_frames, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button seg_frlab_sel = MB_INIT1(&seg_frames_sel, /* next */
									   NOCHILD,         /* children */
									   49, 9, 231, 3,   /* w,h,x,y */
									   NODATA,          /* "Frames:", */
									   black_label, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
);

static Button seg_preview_sel =
	MB_INIT1(&seg_frlab_sel,                                     /* next */
			 NOCHILD,                                            /* children */
			 59, 9, 169, 3,                                      /* w,h,x,y */
			 NODATA,                                             /* "Preview", */
			 ccorner_text, qrender_composite, NOOPT, NOGROUP, 1, /* one for preview */
			 NOKEY, 0                                            /* flags */
	);
static Button seg_render_sel =
	MB_INIT1(&seg_preview_sel,                                            /* next */
			 NOCHILD,                                                     /* children */
			 59, 9, 105, 3,                                               /* w,h,x,y */
			 NODATA,                                                      /* "Render", */
			 ccorner_text, qrender_composite, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);
static Button seg_title_sel =
	MB_INIT1(&seg_render_sel, /* next */
			 NOCHILD,         /* children */
			 94, 9, 4, 3,     /* w,h,x,y */
			 NODATA,          /* "Join", */
...
static Menuhdr seg_menu = MENU_INIT0(320, 98, 0, 0,              /* x,y,w,h */
									 COMPOS_MUID,                /* id */
									 PANELMENU,                  /* type */
...
static Smu_button_list co_smblist[] = {
	{"title", {&seg_title_sel}},       {"name1", {&seg_namea_sel}},     {"name2", {&seg_nameb_sel}},
	{"boxilate", {&seg_boxil_sel}},    {"dissolve", {&seg_disol_sel}},  {"custom", {&seg_mask_sel}},
	{"cut", {&seg_cut_sel}},           {"color", {&seg_clabel_sel}},    {"blend", {&seg_colab_sel}},
	{"col2", {&seg_colb_sel}},         {"col1", {&seg_cola_sel}},       {"rev", {&seg_rev_sel}},
	{"match", {&seg_size_sel}},        {"swapend", {&seg_swap_sel}},    {"still", {&seg_still_sel}},
	{"frames", {&seg_frlab_sel}},      {"preview", {&seg_preview_sel}}, {"rend", {&seg_render_sel}},
...
Errcode reload_mask_cel(void)
{
	...
	if (ccb.mask_cel != NULL && flipaths_same(ccb.maskpath, ccb.mask_cel->cpath)) {
		return (Success);
	}

	if ((err = pdr_load_any_flicel(ccb.maskpath->path, NULL, NULL, &ccb.mask_cel)) < Success) {
		goto error;
	}
...
static Errcode ask_load_mask_cel(void)
{
	...
	for (;;) {
		if (vset_get_filename(stack_string("load_fli_mask", sbuf), suffi, load_str, JOIN_MASK_PATH,
							  path, 0) == NULL) {
			err = Err_abort;
			break;
		}
...
static Errcode load_fli_b(void)
{
	...
	for (;;) {
		snftextf(header, sizeof(header), "!%s", hdtext, pj_get_path_name(ccb.tflxpath->path));
		...
		if ((err = alloc_flipath(path, &ccb.fcelb->flif, &ccb.fcelb->cpath)) < Success) {
			free_fcel(&ccb.fcelb);
			goto error;
		}
		break;
...
static void go_seg_menu(void)
{
	...
	if ((err = soft_buttons("join_panel", co_smblist, Array_els(co_smblist), &ss)) < Success) {
		goto early_error;
	}
 ...
 *----------------------------------------------------------------------*/
{
	...
	if (set_button_disable(b, vs.co_type != COMP_MASK) || ccb.maskpath->path[0] == 0 ||
		ccb.mask_cel == NULL) {
		white_block(b);
		return;
	}
	...
	odat = b->datme;
	snftextf(buf, sizeof(buf), "!%.14s%d%d%d", b->datme, pj_get_path_name(ccb.maskpath->path),
			 ccb.mask_cel->flif.hdr.frame_count, ccb.mask_cel->flif.hdr.width,
...
static void qrender_composite(Button* b)
{
	...
	if ((render_composite(preview) >= Success && !preview) || ccb.fcelb == NULL) {
		mb_gclose_ok(b);
	} else {
		if (vs.co_type == COMP_MASK) {
			reload_mask_cel();
...
static void build_draw_abslid(Button* b, Abslidat* abs)
{
	...
	pj_set_rect(&abs->cb, black, abs->bstart, cent.y, abs->bwid, abs->cb.height - cent.y - 1);

	if (abs->olap_wid) {
		pj_set_rect(&abs->cb, mc_grey(b), abs->olap_start, abs->cb.height >> 2, abs->olap_wid,
					abs->cb.height >> 1);
	}
}
...
static void set_blindmask_size(Button* b)
{
	...
	for (;;) {
		...
		if (!soft_ud_qreq_number(size, 2, maxsize, draw_slatmask, &vertical, "slatsize")) {
			*size = osize;
		}
