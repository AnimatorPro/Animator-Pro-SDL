...
Boolean Qfile(char* suffix, char* button, char* inpath, char* outpath, Boolean force_suffix,
			  char* header);
...
Boolean Qscroll(int* choice, char** items, int icount, int* ipos, char** button_texts,
				char* header);
Boolean UdQnumber(int* num, int min, int max, Errcode (*update)(void* data, int num), void* data,
				  char* fmt, ...);
/********* Graphics library ***********/
...
void IconBlit(char* source, int snext, int sx, int sy, int width, int height, Screen* dest, int dx,
			  int dy, int color);
void Blit(Screen* source, int sx, int sy, int width, int height, Screen* dest, int dx, int dy);
void KeyBlit(Screen* source, int sx, int sy, int width, int height, Screen* dest, int dx, int dy,
			 int key_color);
