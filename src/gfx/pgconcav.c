...
void fill_add_shape(Poly* poly, UBYTE* on_off_buf, SHORT bpr, SHORT xoff, SHORT yoff)
{
	LLpoint* pointpt;
	LLpoint* start;
	SHORT x, y;
...
Errcode fill_on_off(SHORT bpr, SHORT width, SHORT height, SHORT xoff, SHORT yoff, UBYTE* imagept,
