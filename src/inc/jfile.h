...
extern Errcode pj_cpfile(const char* src, const char* dst, Errcode* opt_errfile);

extern Errcode pj_copydata_oset(XFILE* src, XFILE* dst, LONG soset, LONG doset, size_t size);
