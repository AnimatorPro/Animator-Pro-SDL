...
#define AA_NOT_AVAILABLE                                            \
	0               /* library is not available used for host stubs \
					 * loader will ignore this type. */
#define AA_SYSLIB 1 /* low level memory and file utilities */
#define AA_LOADPATH                                              \
	2                 /* special "library" for path used to load \
...
Errcode pj_rexlib_load(char* name, USHORT type, Rexlib** prl, Libhead** hostlibs, char* id_string);
...
#define REX_USERTYPE                             \
	0 /* for use outside of pj domain. Forces id \
...
typedef Errcode (*Rexlib_init)(Rexlib* rl, USHORT host_program, USHORT host_version, void* data);
