...
#define copy_rectfields(src, dst)                                                \
	{                                                                            \
		*((Rectangle*)&((dst)->RECTSTART)) = *((Rectangle*)&((src)->RECTSTART)); \
	}

#define copy_crectfields(src, dst)                                               \
	{                                                                            \
		*((Cliprect*)&((dst)->CRECTSTART)) = *((Cliprect*)&((src)->CRECTSTART)); \
	}
