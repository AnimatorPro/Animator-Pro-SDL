...
typedef void (*rl_type_put_hseg)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w);
typedef void (*rl_type_get_hseg)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w);
typedef void (*rl_type_put_vseg)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor h);
typedef void (*rl_type_get_vseg)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor h);
typedef void (*rl_type_put_rectpix)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w, Ucoor h);
typedef void (*rl_type_get_rectpix)(LibRast* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w, Ucoor h);
typedef void (*rl_type_set_hline)(LibRast* r, Pixel color, Coor x, Coor y, Ucoor w);
typedef void (*rl_type_set_vline)(LibRast* r, Pixel color, Coor x, Coor y, Ucoor h);
typedef void (*rl_type_set_rect)(LibRast* r, Pixel color, Coor x, Coor y, Ucoor w, Ucoor h);
typedef void (*rl_type_set_rast)(LibRast* r, Pixel color);
typedef void (*rl_type_xor_rect)(LibRast* r, Pixel color, Coor x, Coor y, Ucoor w, Ucoor h);
typedef void (*rl_type_mask1blit)(UBYTE* mbytes, unsigned int mbpr, Coor mx, Coor my, LibRast* r,
								  Coor rx, Coor ry, Ucoor width, Ucoor height, Pixel oncolor);
typedef void (*rl_type_mask2blit)(UBYTE* mbytes, unsigned int mbpr, Coor mx, Coor my, LibRast* r,
								  Coor rx, Coor ry, Ucoor width, Ucoor height, Pixel oncolor,
								  Pixel offcolor);
typedef void (*rl_type_unbrun_rect)(LibRast* r, void* ucbuf, LONG pixsize, Coor x, Coor y,
									Ucoor width, Ucoor height);
typedef void (*rl_type_unlccomp_rect)(LibRast* r, void* ucbuf, LONG pixsize, Coor x, Coor y,
									  Ucoor width, Ucoor height);
typedef Errcode (*rl_type_unss2_rect)(LibRast* r, void* ucbuf, LONG pixsize, Coor x, Coor y,
									  Ucoor width, Ucoor height);
typedef void (*rl_type_diag_to_ptable)(LibRast* sr, Pixel* ptable, Ucoor ptsize, Coor x0, Coor y0,
									   Coor x1, Coor y1);
typedef Errcode (*rl_type_blitrect)(LibRast* source, Coor src_x, Coor src_y, LibRast* dest,
									Coor dest_x, Coor dest_y, Ucoor width, Ucoor height);
typedef void (*rl_type_swaprect)(LibRast* ra, Coor ax, Coor ay, LibRast* rb, Coor bx, Coor by,
								 Ucoor width, Ucoor height);
typedef Errcode (*rl_type_tblitrect)(LibRast* s, Coor sx, Coor sy, LibRast* d, Coor dx, Coor dy,
									 Ucoor width, Ucoor height, Pixel tcolor);
typedef Errcode (*rl_type_xor_rast)(LibRast* s, LibRast* d);
typedef Errcode (*rl_type_zoomblit)(LibRast* source, Coor src_x, Coor src_y, LibRast* dest,
									Coor dest_x, Coor dest_y, Ucoor width, Ucoor height,
									LONG zoom_x, LONG zoom_y);
typedef void (*rl_type_set_colors)(LibRast* r, LONG start, LONG count, void* cbuf);
...
#define SET_RECT(r, c, x, y, w, h) (*((r)->lib->set_rect))((LibRast*)(r), c, x, y, w, h)
#define XOR_RECT(r, c, x, y, w, h) (*((r)->lib->xor_rect))((LibRast*)(r), c, x, y, w, h)
...
#define MASK2BLIT(mp, bpr, mx, my, r, rx, ry, w, h, oncol, offcol) \
	(*((r)->lib->mask2blit))(mp, bpr, mx, my, (LibRast*)(r), rx, ry, w, h, oncol, offcol)
#define SET_COLORS(r, start, count, cbuf) \
	(*((r)->lib->set_colors))((LibRast*)(r), start, count, cbuf)
#define UNCC64(r, cbuf) (*((r)->lib->uncc64))((LibRast*)(r), cbuf)
#define UNCC256(r, cbuf) (*((r)->lib->uncc256))((LibRast*)(r), cbuf)
#define WAIT_VSYNC(r) (*((r)->lib->wait_vsync))((LibRast*)(r))
