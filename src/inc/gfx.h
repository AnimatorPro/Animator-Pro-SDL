...
void image_scale_tblit(Image* i, Pixel* colors, Raster* dst, Coor dx, Coor dy, Ucoor dw, Ucoor dh);
...
void pj_scale_blit(Raster* src, Coor sx, Coor sy, Ucoor sw, Ucoor sh, Raster* dst, Coor dx, Coor dy,
				   Ucoor dw, Ucoor dh, Tcolxldat* tcxl);
...
void ublitrect(const Raster* s, Coor sx, Coor sy, const Raster* d, Coor dx, Coor dy, Ucoor width,
			   Ucoor height, const Pixel tcolor);


void blitmove_rect(Raster* s, Coor sx, Coor sy, Raster* d, Coor dx, Coor dy, Ucoor width,
				   Ucoor height);
...
void do_leftbehind(Coor sx, Coor sy, Coor dx, Coor dy, Coor width, Coor height,
				   do_leftbehind_func func, void*);

void set_leftbehind(Raster* s, Pixel color, Coor sx, Coor sy, Coor dx, Coor dy, Coor width,
					Coor height);


void max_line(Raster* r, Short_xy* ends, dotout_func dotout, void* dotdat);

void pj_cline(SHORT x1, SHORT y1, SHORT x2, SHORT y2, dotout_func dotout, void* dotdat);

void pj_do_linscale(int sx, int sw, int dx, int dw, void (*doinc)(int sx, int dx, void* dat),
					void* dat);
...
void cline_frame(SHORT x0, SHORT y0, SHORT x1, SHORT y1, dotout_func dotout, void* dotdat);

extern void draw_quad(Raster* r, Pixel col, SHORT x, SHORT y, USHORT w, USHORT h);

extern Errcode rcircle(SHORT xcen, SHORT ycen, SHORT rad, dotout_func dotout, void* dotdat,
					   hline_func hline, void* hldat, bool filled);

extern Errcode dcircle(SHORT xcen, SHORT ycen, SHORT diam, dotout_func dotout, void* dotdat,
					   hline_func hline, void* hldat, bool filled);

extern Errcode doval(SHORT xcen, SHORT ycen, SHORT xdiam, SHORT xaspect, SHORT yaspect,
					 dotout_func dotout, void* dotdat, hline_func hline, void* hldat, bool filled);
...
void circle(void* r, Pixel color, Coor centx, Coor centy, Ucoor diam, bool filled);
...
void set_bit_hline(unsigned char* buf, unsigned int bpr, unsigned int y, unsigned int x1,
				   unsigned int x2);
