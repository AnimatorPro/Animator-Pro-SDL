...
#define CEL_FIELDS struct cmap* cmap
...
Errcode open_vd_rcel(Vdevice* vd, Rasthdr* spec, Rcel* cel, LONG num_colors, UBYTE displayable);

Errcode alloc_vd_rcel(Vdevice* vd, Rasthdr* spec, Rcel** pcel, LONG num_colors, UBYTE displayable);
...
typedef void (*Celblit)(Rcel* rcel, SHORT x, SHORT y, Rcel* d, SHORT dx, SHORT dy, SHORT w, SHORT h,
						Tcolxldat* txd);
