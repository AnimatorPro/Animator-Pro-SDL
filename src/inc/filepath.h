...
extern Errcode filepath_to_cstr(const FilePath* filepath, char delim, char* str, size_t n);
...
sample usage:
{
	...
	*pj_get_path_suffix(path) = 0;
	...
	Errcode dice_file_name(char* path, char* device, char* dir, char* file, char* suffix);
