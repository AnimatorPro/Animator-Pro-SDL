...
#define DLHEADER_INIT(name) {(Dlnode*)(&((name).tail)), NULL, (Dlnode*)(&((name).head))}
...
extern void sort_indarray(void** array, LONG count, int (*cmp)(void* a, void* b, void* cmpdat),
						  void* cmpdat);

extern void* sort_slist(Slnode* list, int (*cmp)(void* a, void* b, void* cmpdat), void* cmpdat);
