...
extern void some_cmod(void (*f)(int scale, struct rgb3* p, int cix, int ix), int scale);
...
/* cthread.c */
extern void rthread_cmap(UBYTE* gotit, struct rgb3* scmap, struct rgb3* dcmap, int inertia,
						 int ccount);
