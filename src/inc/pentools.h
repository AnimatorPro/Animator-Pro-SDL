...
extern Errcode dtool_loop(Errcode (*get_posp)(struct pos_p*, void*, SHORT), void* idata,
						  SHORT mode);

extern Errcode spray_loop(Errcode (*get_posp)(struct pos_p*, void*, SHORT), void* idata,
						  bool redoing);
...
/* gel.c */
extern Errcode gel_tool_loop(Errcode (*get_posp)(struct pos_p*, void*, SHORT), void* idata);
