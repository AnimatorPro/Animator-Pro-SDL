...
extern void zoom_put_hseg(struct raster* r, Pixel* pixbuf, Coor x, Coor y, Ucoor width);

extern void zoom_txlatblit(struct raster* src, Coor sx, Coor sy, Ucoor width, Ucoor height, Coor dx,
						   Coor dy, struct tcolxldat* tcxl);

extern void zoom_put_vseg(struct raster* r, Pixel* pixbuf, Coor x, Coor y, Ucoor height);

extern void zoom_blitrect(struct raster* src, Coor sx, Coor sy, Coor x, Coor y, Coor width,
						  Coor height);
