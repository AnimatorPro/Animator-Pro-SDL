...
#define SBUF_SIZE                                  \
	1024 /* size of allowable stack buffer used in \
		  * raster calls */
...
bool pj_clipbox_make(Clipbox* cb, RASType* r, Coor x, Coor y, Coor width, Coor height);
...
Errcode pj_open_temprast(Bytemap* rr, SHORT width, SHORT height, SHORT pdepth);
...
extern void _pj_put_rectpix(RASType* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w, Ucoor h);

extern void pj_get_rectpix(RASType* r, Pixel* pixbuf, Coor x, Coor y, Ucoor w, Ucoor h);
...
void pj__mask1blit(UBYTE* bitplane, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
				   Ucoor width, Ucoor height, Pixel oncolor);

void pj_mask1blit(UBYTE* bitplane, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
				  Ucoor width, Ucoor height, Pixel oncolor);

void pj__mask2blit(UBYTE* bitplane, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
				   Ucoor width, Ucoor height, Pixel oncolor, Pixel offcolor);

void pj_mask2blit(UBYTE* bitplane, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
				  Ucoor width, Ucoor height, Pixel oncolor, Pixel offcolor);

/* decompressors */

void pj_unbrun_rect(RASType* r, void* ucbuf, LONG pixsize, Coor x, Coor y, Ucoor width,
					Ucoor height);

void pj_unlccomp_rect(RASType* r, void* ucbuf, LONG pixsize, Coor x, Coor y, Ucoor width,
					  Ucoor height);

void pj_unss2_rect(RASType* r, void* ucbuf, LONG pixsize, Coor x, Coor y, Ucoor width,
				   Ucoor height);
...
extern Errcode pj__blitrect(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x,
							Coor dest_y, Ucoor width, Ucoor height);

void pj_blitrect(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x, Coor dest_y,
				 Ucoor width, Ucoor height);

extern Errcode pj__tblitrect(RASType* s, Coor sx, Coor sy, RASType* d, Coor dx, Coor dy,
							 Ucoor width, Ucoor height, Pixel tcolor);

void pj_tblitrect(RASType* s, Coor sx, Coor sy, RASType* d, Coor dx, Coor dy, Coor width,
				  Coor height, Pixel tcolor);


void pj__swaprect(RASType* ra, Coor ax, Coor ay, RASType* rb, Coor bx, Coor by, Ucoor width,
				  Ucoor height);

void pj_swaprect(RASType* ra, Coor ax, Coor ay, RASType* rb, Coor bx, Coor by, Coor width,
				 Coor height);


extern Errcode pj_zoomblit(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x,
						   Coor dest_y, Ucoor width, Ucoor height, LONG zoom_x, LONG zoom_y);
...
void pj_diag_to_ptable(RASType* sr, Pixel* ptable, Ucoor ptsize, Coor x0, Coor y0, Coor x1,
					   Coor y1);
