...
typedef struct gfxlib {
	...
	Errcode (*open_temprast)(Bytemap* r, SHORT width, SHORT height, SHORT pdepth);
	...
	void (*mask1blit)(UBYTE* mbytes, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
					  Ucoor width, Ucoor height, Pixel oncolor);
	void (*mask2blit)(UBYTE* mbytes, Coor mbpr, Coor mx, Coor my, RASType* r, Coor rx, Coor ry,
					  Ucoor width, Ucoor height, Pixel oncolor, Pixel offcolor);
	/* binary calls */

	void (*xor_rast)(RASType* s, RASType* d);

	void (*_blitrect)(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x,
					  Coor dest_y, Coor width, Coor height);

	void (*blitrect)(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x,
					 Coor dest_y, Coor width, Coor height);

	void (*_tblitrect)(RASType* s, Coor sx, Coor sy, RASType* d, Coor dx, Coor dy, Coor width,
					   Coor height, Pixel tcolor);

	void (*tblitrect)(RASType* s, Coor sx, Coor sy, RASType* d, Coor dx, Coor dy, Coor width,
					  Coor height, Pixel tcolor);

	void (*_swaprect)(RASType* ra, Coor ax, Coor ay, RASType* rb, Coor bx, Coor by, Coor width,
					  Coor height);

	void (*swaprect)(RASType* ra, Coor ax, Coor ay, RASType* rb, Coor bx, Coor by, Coor width,
					 Coor height);


	void (*zoomblit)(RASType* source, Coor src_x, Coor src_y, RASType* dest, Coor dest_x,
