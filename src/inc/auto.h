...
typedef Errcode (*autoarg_func)(void* data, int ix, int intween, int scale, struct autoarg* aa);
...
#define AUTO_READONLY                                                   \
	0x0001                    /* doesn't need to save screen only reads \
...
#define AUTO_PREVIEW_ONLY                       \
	0x0200 /* multi menu is only to do preview, \
