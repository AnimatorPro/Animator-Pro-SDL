...
#define FA_PARSE_MODE                                        \
	0x01 /* if set, fa_getchar() will only return the        \
...
#define FA_ABORT_ON_ERROR                        \
	0x04 /* abort format if an invalid format is \
