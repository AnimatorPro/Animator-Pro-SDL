...
extern Errcode pj_read_picbody(XFILE* xf, Pic_header* pic, Raster* cel, struct cmap* cmap);
...
extern Errcode find_pdr_loader(char* ifname, bool multi_frame, struct anim_info* ainfo,
							   char* pdr_name, Rcel* screen);
