...
extern void rub_poly_points(Poly* p, bool closed, Pixel dit_color, Pixel dot_color, Pixel pt_color,
							Pixel pt1_color);
...
extern Errcode rub_keep_star_type(struct poly* p, int startype, int color, int* ptheta, int* prad,
								  int* prad2);
