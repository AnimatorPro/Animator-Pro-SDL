...
char* vset_get_filename(char* prompt, char* suffi, char* button, int path_type, char* outpath,
						bool force_suffix)
{
	char* retp;
	...
	retp = pj_get_filename(prompt, suffi, button, cpath.path, cpath.path, force_suffix,
