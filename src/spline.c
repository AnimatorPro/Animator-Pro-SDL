...
static void do_spline(fixpoint* knotx, fixpoint* knoty, int knots, int interps, int type,
					  dotout_func dotout, void* dotdat,
					  void (*vecout)(SHORT, SHORT, SHORT, SHORT, dotout_func, void*), Poly* polyout,
...
static Errcode s_spline(Poly* polyin, dotout_func dotout, void* dotdat,
						void (*vecout)(SHORT, SHORT, SHORT, SHORT, dotout_func, void*), int closed,
						int ir, Poly* polyout, int moving_point_ix, int invert_segment)
...
/* of interpreted points to generate.				   */
{
	...
	do_spline(newx, newy, ptcount, ir, closed, dotout, dotdat, vecout, polyout, moving_point_ix,
			  invert_segment);
	free_spline_tab();
...
int some_spline(Poly* poly, dotout_func dotout, void* dotdat,
				void (*vecout)(SHORT, SHORT, SHORT, SHORT, dotout_func, void*), int closed, int ir)
{
	LLpoint* p;
...
int partial_spline(Poly* poly, dotout_func dotout, void* dotdat,
				   void (*vecout)(SHORT, SHORT, SHORT, SHORT, dotout_func, void*), int closed,
				   int ir, int moving_point_ix, int invert_seg)
{
	return (s_spline(poly, dotout, dotdat, vecout, closed, ir, NULL, moving_point_ix, invert_seg));
}
