...
#define UNBUZZ_OF(a, t, b, om, tm) (((LONG)((LONG)(a + b) * om) + (LONG)(t * tm)) / 300)
...
RootInk unbuzz_ink_opt = {
	INKINIT(NONEXT, RL_KEYTEXT("unbuzz_n") "UnBuzz", INK_OPT, 0, RL_KEYTEXT("unbuzz_help"),
			NO_SUBOPTS, unbuzz_dot, unbuzz_hline, 75, FALSE, NO_MC, NO_FC, INK_NEEDS_UNDO, ),
	init_unbuzz,
};
