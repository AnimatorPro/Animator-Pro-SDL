...
RootInk quantize_ink_opt = {
	INKINIT(NONEXT, RL_KEYTEXT("quantize_n") "Quantize", INK_OPT, 0,
			RL_KEYTEXT("or_help") "Set pixel to be a discrete distance from neighbor", NO_SUBOPTS,
			quantize_dot, quantize_hline, NOSTRENGTH, FALSE, NO_MC, NO_FC, INK_NEEDS_UNDO, ),
	init_quantize,
};
