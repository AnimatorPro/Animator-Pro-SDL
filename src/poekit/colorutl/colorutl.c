...
static const PocoBindingPointerContract color_difference_spans[] = {
	{0, POCO_POINTER_PERMISSION_READ, 1, POCO_BINDING_SPAN_BYTES, 3 * sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{1, POCO_POINTER_PERMISSION_READ, 1, POCO_BINDING_SPAN_BYTES, 3 * sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
};
static const PocoBindingPointerContract closest_color_spans[] = {
	{0, POCO_POINTER_PERMISSION_READ, 1, POCO_BINDING_SPAN_BYTES, 3 * sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{1, POCO_POINTER_PERMISSION_READ, 1, POCO_BINDING_SPAN_BYTES, 3 * sizeof(int), 2,
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
};
static const PocoBindingPointerContract menu_indexes_spans[] = {
	{0, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, 5 * sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
};
static const PocoBindingPointerContract rgb_to_hls_spans[] = {
	{3, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{4, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{5, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
};
static const PocoBindingPointerContract hls_to_rgb_spans[] = {
	{0, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{1, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
	{2, POCO_POINTER_PERMISSION_WRITE, 1, POCO_BINDING_SPAN_BYTES, sizeof(int),
	 POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE, POCO_BINDING_PARAMETER_NONE},
};
